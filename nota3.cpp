...
float calcula_definitiva();  //Prototipo de la función

float act_individual, act_grupal, act_foro, autoevaluacion; // VARIABLES GLOBALES

int main()
{
	float definitiva;  // VARIABLE LOCAL
	...
	definitiva = calcula_definitiva();
	
	cout<<"\nNOTA DEFINITIVA: "<<definitiva<<endl;
	return 0;
}
//IMPLEMETACION DE LA FUNCION
float calcula_definitiva()
{
	float def;  //VARIABLE LOCAL
